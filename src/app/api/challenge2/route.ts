...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        if (flag == 'Congratulations! You have solved the first Ultimate Challenge of Code Sprint 3.0') {
            await User.findByIdAndUpdate(userId, { $inc: { capturedFlags: 1, TotalPoints: 8 } });
